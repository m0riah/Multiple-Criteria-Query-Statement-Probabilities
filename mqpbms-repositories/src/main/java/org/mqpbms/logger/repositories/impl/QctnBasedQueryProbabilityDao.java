...
/**
 * Query Command and Table Names (QCTN) based Query Probability Table data access object
 *
 * @author sky
 * @version 2/9/14
 */
@Repository("QctnBasedQueryProbabilityDao")
public class QctnBasedQueryProbabilityDao implements QueryProbabilityDao {

    /**
     * Table base name.
     */
    private static final String TABLE_BASE_NAME = "_qctn_qp";
