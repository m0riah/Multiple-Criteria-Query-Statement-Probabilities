...
/**
 * Query Command and Table Names (QCTN) based Query Transition Table data access object.
 *
 * @author sky
 * @version 2/9/14
 */
@Repository("QctnBasedQueryTransitionProbabilityDao")
public class QctnBasedQueryTransitionProbabilityDao implements QueryTransitionProbabilityDao {
