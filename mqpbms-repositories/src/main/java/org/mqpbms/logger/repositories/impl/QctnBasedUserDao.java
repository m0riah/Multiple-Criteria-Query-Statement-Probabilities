...
/**
 * Signature based User table data access object
 *
 * @author sky
 * @version 1/9/14
 */
@Repository("QctnBasedUserDao")
public class QctnBasedUserDao implements UserDao, InitializingBean {

    /**
     * Table name.
     */
    private static final String USER_TABLE_NAME = "qctn_users";
