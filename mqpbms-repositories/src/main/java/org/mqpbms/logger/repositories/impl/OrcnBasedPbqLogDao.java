...
/**
 * Operation Related Column Names based Probability Based Query (PBQ) Log data access object.
 *
 * @author sky
 * @version 2/14/14
 */
@Repository("OrcnBasedPbqLogDao")
public class OrcnBasedPbqLogDao implements PbqLogDao {

    /**
     * Table base name.
     */
    private static final String TABLE_BASE_NAME = "_orcn_pbq";
